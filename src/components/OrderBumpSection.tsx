...
const OrderBumpSection = () => (
  <section className="section-padding bg-card/50">
    <div className="section-container">
      <div className="max-w-2xl mx-auto rounded-2xl border-2 border-dashed border-primary/30 bg-background p-6 md:p-8">
        ...
        <button className="mt-6 w-full sm:w-auto px-6 py-3 rounded-xl border-2 border-primary text-primary font-semibold text-sm hover:bg-primary hover:text-primary-foreground transition-colors">
